...
1. [Test Generation Using Symbolic Execution](https://patricegodefroid.github.io/public_psfiles/fsttcs2012.pdf)
...
1. [The Frog-Boiling Attack: Limitations of Anomaly Detection for Secure Network Coordinate Systems](https://chantin.cs.luc.edu/~chantin/frogBoiling.pdf)
1. [From inter to intra: gaining reliability](https://googleprojectzero.blogspot.com/2015/07/from-inter-to-intra-gaining-reliability_10.html)
1. [What is a "good" memory corruption vulnerability?](https://googleprojectzero.blogspot.com/2015/06/what-is-good-memory-corruption.html)
1. [Asterisk Exploit](https://blog.exodusintel.com/tag/asterisk-exploit/)
1. [FireEye Exploitation: Project Zero’s Vulnerability of the Beast](https://googleprojectzero.blogspot.com/2015/12/fireeye-exploitation-project-zeros.html)
1. [Bugs as Deviant Behavior: A General Approach to Inferring Errors in Systems Code](https://web.stanford.edu/~engler/deviant-sosp-01.pdf)
1. [[0day] [exploit] Advancing exploitation: a scriptless 0day exploit against Linux desktops](https://scarybeastsecurity.blogspot.com/2016/11/0day-exploit-advancing-exploitation.html)
1. [Redux: compromising Linux using... SNES Ricoh 5A22 processor opcodes?!](https://scarybeastsecurity.blogspot.com/2016/12/redux-compromising-linux-using-snes.html)
1. [Machine Learning Applications for Data Center Optimization](https://static.googleusercontent.com/media/research.google.com/en//pubs/archive/42542.pdf)
1. [Serverless Computing: One Step Forward, Two Steps Back](https://arxiv.org/abs/1812.03651)
1. [[0day] [exploit] Compromising a Linux desktop using... 6502 processor opcodes on the NES?!](https://scarybeastsecurity.blogspot.com/2016/11/0day-exploit-compromising-linux-desktop.html)
1. [Identifying and Exploiting Windows Kernel Race Conditions via Memory Access Patterns](https://storage.googleapis.com/pub-tools-public-publication-data/pdf/42189.pdf)
1. [TextBugger: Generating Adversarial Text Against Real-world Applications](https://arxiv.org/abs/1812.05271)
1. [Repeatable Reverse Engineering with PANDA](https://dl.acm.org/doi/10.1145/2843859.2843867)
1. [Bluetooth Application-Layer Packet-Filtering For Blueborne Attack Defending](https://ieeexplore.ieee.org/document/8795354)
1. [Intrusion Detection for IoT Devices based on RF Fingerprinting using Deep Learning](https://ieeexplore.ieee.org/abstract/document/8795319)
1. [Detecting and Predicting Anomalies for Edge Cluster Environments using Hidden Markov Models](https://ieeexplore.ieee.org/stamp/stamp.jsp?arnumber=8795337)
1. [Exception-oriented exploitation on iOS](https://googleprojectzero.blogspot.com/2017/04/exception-oriented-exploitation-on-ios.html)
1. [An MDE-based approach for self-adaptive RTES model generation](https://link.springer.com/article/10.1007/s10586-019-02968-4)
...
1. [KLEE: Unassisted and Automatic Generation of High-Coverage Tests for Complex Systems Programs](https://www.usenix.org/legacy/event/osdi08/tech/full_papers/cadar/cadar.pdf)
1. [SoK: Eternal War in Memory](https://people.eecs.berkeley.edu/~dawnsong/papers/Oakland13-SoK-CR.pdf)
1. [Effective File Format Fuzzing – Thoughts, Techniques and Results (Black Hat Europe 2016)](https://j00ru.vexillium.org/talks/blackhat-eu-effective-file-format-fuzzing-thoughts-techniques-and-results/)
1. [(State of) The Art of War: Offensive Techniques in Binary Analysis](https://ieeexplore.ieee.org/stamp/stamp.jsp?tp=&arnumber=7546500&tag=1)
1. [Under-Constrained Symbolic Execution: Correctness Checking for Real Code](https://www.usenix.org/system/files/conference/usenixsecurity15/sec15-paper-ramos.pdf)
...
1. [Vudo - An object superstitiously believed to embody magical powers](http://phrack.org/issues/57/8.html#article)
1. [INTERPRETER EXPLOITATION: POINTER INFERENCE AND JIT SPRAYING](http://citeseerx.ist.psu.edu/viewdoc/download;jsessionid=346E293568983B3CB049B231037AAC60?doi=10.1.1.173.3355&rep=rep1&type=pdf)
1. [Computer security, privacy, and DNA sequencing: compromising computers with synthesized DNA, privacy leaks, and more](https://dl.acm.org/doi/10.5555/3241189.3241249)
1. [Once upon a free()](http://phrack.org/issues/57/9.html)
1. [Using Memory Errors to Attack a Virtual Machine](https://www.cs.princeton.edu/~appel/papers/memerr.pdf)
1. [Chrome OS exploit: one byte overflow and symlinks](https://googleprojectzero.blogspot.com/2016/12/chrome-os-exploit-one-byte-overflow-and.html)
1. [The Stack Clash](https://www.qualys.com/2017/06/19/stack-clash/stack-clash.txt)
1. [Chainspotting: Building Exploit Chains with Logic Bugs](https://labs.f-secure.com/archive/chainspotting-building-exploit-chains-with-logic-bugs/)
1. [FUDGE: Fuzz Driver Generation at Scale](https://storage.googleapis.com/pub-tools-public-publication-data/pdf/d92eead1d1b76495e7cc148adf249ea50f3b881e.pdf)
...
1. [Webcache poisioning](https://portswigger.net/kb/papers/7q1e9u9a/web-cache-poisoning.pdf)
...
1. [Anomaly detection: A survey](https://dl.acm.org/doi/10.1145/1541880.1541882)
1. [An Intrusion-Detection Model](https://ieeexplore.ieee.org/document/1702202)
1. [A Case Study in Power Substation Network Dynamics](https://cap.ece.gatech.edu/papers/formby_sigmetrics17_power_substation.pdf)
1. [Analysis of the Cyber Attack on the Ukrainian Power Grid](https://ics.sans.org/media/E-ISAC_SANS_Ukraine_DUC_5.pdf)
1. [Simulated Attack on DNP3 Protocol in SCADA System](https://www.semanticscholar.org/paper/Simulated-Attack-on-DNP3-Protocol-in-SCADA-System-Lee-Kim/9ec1fefb804523a8851043a802ad671d0bf7ecdf)
1. [PowerHammer: Exfiltrating Data from Air-Gapped Computers through Power Lines](https://arxiv.org/pdf/1804.04014.pdf)
1. [Adversarial Machine Learning](https://people.eecs.berkeley.edu/~tygar/papers/SML2/Adversarial_AISEC.pdf)
1. [Quantum secret sharing with polarization-entangled photon pairs](https://www.osti.gov/biblio/1528726-quantum-secret-sharing-polarization-entangled-photon-pairs)
1. [LogP: Towards a Realistic Model of Parallel Computation](https://people.eecs.berkeley.edu/~kubitron/cs258/handouts/papers/logp.pdf)
1. [Online Anomaly Detection under Adversarial Impact](http://proceedings.mlr.press/v9/kloft10a/kloft10a.pdf)
1. [Top 10 algorithms in data mining](https://dl.acm.org/doi/10.1007/s10115-007-0114-2)
1. [Tools, Techniques, and Methodologies: A Survey of Digital Forensics for SCADA Systems](https://www.osti.gov/biblio/1493135-tools-techniques-methodologies-survey-digital-forensics-scada-systems)
1. [The Industrial Control System Cyber Kill Chain](https://www.sans.org/reading-room/whitepapers/ICS/industrial-control-system-cyber-kill-chain-36297)
