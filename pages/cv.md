...
<a href="{{ site.url }}/files/Robert_Gillen_CV_200923.pdf" class="social-icons" title="Printer friendly format"><i class="fa fa-print"></i></a>
</span>
...
<iframe src="{{ site.url }}/files/Robert_Gillen_CV_200923.pdf" width="100%" style="height: 100vh;"></iframe>
