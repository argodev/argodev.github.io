...
Rob works in Vulnerability Science and is part of the Cyber and Applied Data Analytics division at the [Oak Ridge National Laboratory](https://www.ornl.gov/). In his role as a research professional, works alongside domain scientists to deliver solutions to complex problems at a national scale. The mission of his group is as follows: _"Applied research and development to understand, defend, and secure the computing and communication networks in the nation's critical industry, energy and defense infrastructure"_. His current research interests include large-scale text analysis, cyber security, machine learning and embedded systems. Some of his publications can be viewed via his [ORCID page](https://orcid.org/{{ site.owner.orcid }}).
